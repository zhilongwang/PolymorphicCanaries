...
bool StackDoubleProtector1::ContainsProtectableArray(Type *Ty, bool &IsLarge, bool Strong, bool InStruct) const {
	if (!Ty)
		return false;
...
bool StackDoubleProtector1::HasAddressTaken(const Instruction *AI) {
...
/// address taken.
bool StackDoubleProtector1::RequiresStackProtector() {
	bool Strong = false;
	bool NeedsProtector = false;
	Strong = true;
...
static bool CreatePrologue(Function *F, Module *M, ReturnInst *RI,
	...
	AI2 = B.CreateAlloca(PtrTy, nullptr, "StackDoubleStackSlot2");
	...
	B.CreateStore(loadedDoubleGuard1, AI1, true);
...
BasicBlock *StackDoubleProtector1::CreateFailBB() {
...
bool StackDoubleProtector1::InsertStackDoubleProtectors() {
	...
	for (Function::iterator I = F->begin(), E = F->end(); I != E;) {
		...
		IRBuilder<> B(BB);
		Value* stackGuard = getTheStackGuardValue(B, 0x2a0);
